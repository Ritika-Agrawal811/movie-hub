    ...
    return (
        <section className='carousel'>
            <ContentWrapper>
                ...
                <BsFillArrowLeftCircleFill className='carousel__left-arrow arrow' onClick={() => navigation("left")} />
                ...
                {!loading && data.length !== 0 ? (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className='carousel__content'>
                                        ...
                                        <time className='date'>{dayjs(item.release_Date).format("MMM D, YYYY")}</time>
                                    </div>
                                </div>
                            )
                        })}
                    ...
                    <div className='loadingSkeleton'>{[1, 2, 3, 4, 5].map((value) => skeletonItem(value))}</div>
                )}
            </ContentWrapper>
        </section>
    )
