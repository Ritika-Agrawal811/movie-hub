...
const Footer = () => {
    ...
    return (
        <footer className='page__footer'>
            <ContentWrapper>
                <div className='col company__details'>
                    ...
                    <p className='company__info'>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia, corrupti placeat inventore
                        eligendi obcaecati recusandae sit voluptate quis nisi exercitationem, accusantium sapiente, rem
            ...
            <hr />
            <ContentWrapper>
                <p className='company__copyright'>Copyright &copy; {today.getFullYear()}</p>
            </ContentWrapper>
        </footer>
    )
}
